...
fn.plot.restriction(
  tmp.var.Type   = 'continuous',
  tmp.imp.Method = 'ppd',
  # tmp.evaluation.Metric = 'Imputed.Values.RMSE',
  tmp.evaluation.Metric = 'mdl.Y.coef.RMSE',
  label.evaluation.Metric = 'Model Coefficients - RMSE',
...
fn.plot.restriction(
  ...
  tmp.imp.Method = 'ppd',
  # tmp.evaluation.Metric = 'Imputed.Values.RMSE',
  tmp.evaluation.Metric = 'mdl.Y.coef.Bias',
  label.evaluation.Metric = 'Model Coefficients - Bias',
  legend.text.Indicator = 'Yes'
)
...
for (value.Type in Options.value.Type) {
  ...
  png(paste0('03.Figures/', var.Type, '.', imp.Method, '.', gsub(' ', '\\.', value.Type), '.png'), 
